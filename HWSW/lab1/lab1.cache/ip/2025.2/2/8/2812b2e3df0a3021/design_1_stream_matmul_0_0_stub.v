...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_stream_matmul_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_stream_matmul_0_0,stream_matmul,{}" *) (* CORE_GENERATION_INFO = "design_1_stream_matmul_0_0,stream_matmul,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=stream_matmul,x_ipVersion=1.0,x_ipCoreRevision=2114615013,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=5,C_S_AXI_CONTROL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
