...
status = comp.import_files(from_loc="$COMPONENT_LOCATION/../../HWSW-CD/HWSW", files=["stream_matmul_dma_app.c"], dest_dir_in_cmp = "src", is_skip_copy_sources = False)
