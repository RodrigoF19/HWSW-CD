...
# 
# ==============================================================
set ::env(PATH) "D:/2025.1/Vitis/win64/tools/fpo_v7_1;$::env(PATH)"
set ::env(PATH) "D:/2025.1/Vitis/win64/tools/fft_v9_1;$::env(PATH)"
set ::env(PATH) "D:/2025.1/Vitis/win64/tools/fir_v7_0;$::env(PATH)"
set ::env(PATH) "D:/2025.1/Vitis/win64/tools/dds_v6_0;$::env(PATH)"
set ::env(PATH) "D:/2025.1/Vitis/tps/mingw/10.0.0/win64.o/nt/bin;$::env(PATH)"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "stream_matmul.autotvin.dat"
	set constFileTvOut       "stream_matmul.autotvout.dat"
	set constFileHdlTvIn     "stream_matmul.autohdltvin.dat"
	set constFileHdlTvOut    "stream_matmul.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
