...
if {[file isfile stream_matmul.autotvin.dat]} {
	file delete -force stream_matmul.autotvin.dat
}

if {[file isfile stream_matmul.autotvout.dat]} {
	file delete -force stream_matmul.autotvout.dat
}
