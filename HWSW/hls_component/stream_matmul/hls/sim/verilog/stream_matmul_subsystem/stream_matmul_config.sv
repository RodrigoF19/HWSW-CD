...
//
//==============================================================
`ifndef STREAM_MATMUL_CONFIG__SV                        
    `define STREAM_MATMUL_CONFIG__SV                    
                                                            
    class stream_matmul_config extends uvm_object;            
        ...
        `uvm_object_utils_begin(stream_matmul_config)         
        ...
        function new (string name = "stream_matmul_config");
            super.new(name);                                
