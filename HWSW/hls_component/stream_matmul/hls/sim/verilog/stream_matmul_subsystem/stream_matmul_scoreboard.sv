...
//
//==============================================================
`ifndef STREAM_MATMUL_SCOREBOARD__SV                                                       
    `define STREAM_MATMUL_SCOREBOARD__SV                                                   
                                                                                               
    `define AUTOTB_TVOUT_out_stream_out_stream_TDATA_wrapc  "../tv/rtldatafile/rtl.stream_matmul.autotvout_out_stream_V_data_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TKEEP_wrapc  "../tv/rtldatafile/rtl.stream_matmul.autotvout_out_stream_V_keep_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TSTRB_wrapc  "../tv/rtldatafile/rtl.stream_matmul.autotvout_out_stream_V_strb_V.dat"
    `define AUTOTB_TVOUT_out_stream_out_stream_TLAST_wrapc  "../tv/rtldatafile/rtl.stream_matmul.autotvout_out_stream_V_last_V.dat"
    ...
    class stream_matmul_scoreboard extends uvm_component;                                        
        ...
        `uvm_component_utils_begin(stream_matmul_scoreboard)                                     
        ...
        virtual function void write_svr_slave_out_stream(svr_transfer#(41) tr);
            ...
            file_wr_port_out_stream_out_stream_TLAST.write_TVOUT_data(tr.data[40: 40]);
