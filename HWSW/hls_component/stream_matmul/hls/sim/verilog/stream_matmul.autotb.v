...
`define AUTOTB_DUT      stream_matmul
`define AUTOTB_DUT_INST AESL_inst_stream_matmul
`define AUTOTB_TOP      apatb_stream_matmul_top
`define AUTOTB_LAT_RESULT_FILE "stream_matmul.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "stream_matmul.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_stream_matmul_top
...
`define AUTOTB_TVOUT_out_stream_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.stream_matmul.autotvout_out_stream_V_data_V.dat"
`define AUTOTB_TVOUT_out_stream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.stream_matmul.autotvout_out_stream_V_keep_V.dat"
`define AUTOTB_TVOUT_out_stream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.stream_matmul.autotvout_out_stream_V_strb_V.dat"
