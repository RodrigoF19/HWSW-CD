...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.stream_matmul.autotvin_in_stream_V_data_V.dat"
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.stream_matmul.autotvout_out_stream_V_data_V.dat"
         "rtl.stream_matmul.autotvout_out_stream_V_keep_V.dat"
         "rtl.stream_matmul.autotvout_out_stream_V_strb_V.dat"
         "rtl.stream_matmul.autotvout_out_stream_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
