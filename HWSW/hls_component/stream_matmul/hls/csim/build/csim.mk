...
HLS_SOURCES = ../../../../../tb_stream_matmul_fixedPoint.cpp ../../../../../stream_matmul_fixedPoint.cpp
...
$(ObjDir)/tb_stream_matmul_fixedPoint.o: ../../../../../tb_stream_matmul_fixedPoint.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../tb_stream_matmul_fixedPoint.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_stream_matmul_fixedPoint.d

$(ObjDir)/stream_matmul_fixedPoint.o: ../../../../../stream_matmul_fixedPoint.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../stream_matmul_fixedPoint.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=stream_matmul $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/stream_matmul_fixedPoint.d
