set SynModuleInfo {
  ...
  {SRCNAME stream_matmul_Pipeline_compute_i_compute_j_compute_k MODELNAME stream_matmul_Pipeline_compute_i_compute_j_compute_k RTLNAME stream_matmul_stream_matmul_Pipeline_compute_i_compute_j_compute_k
    SUBMODULES {
