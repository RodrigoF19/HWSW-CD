set moduleName stream_matmul_Pipeline_VITIS_LOOP_55_1_VITIS_LOOP_56_2
set isTopModule 0
...
set cdfgNum 8
set C_modelName {stream_matmul_Pipeline_VITIS_LOOP_55_1_VITIS_LOOP_56_2}
...
set C_modelArgList {
	{ C float 32 regular {array 256 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
