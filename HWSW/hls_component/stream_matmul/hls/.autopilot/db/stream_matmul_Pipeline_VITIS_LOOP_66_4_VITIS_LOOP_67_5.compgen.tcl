...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A \
    op interface \
    ports { A_address0 { O 6 vector } A_ce0 { O 1 bit } A_we0 { O 1 bit } A_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A_1 \
    op interface \
    ports { A_1_address0 { O 6 vector } A_1_ce0 { O 1 bit } A_1_we0 { O 1 bit } A_1_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A_2 \
    op interface \
    ports { A_2_address0 { O 6 vector } A_2_ce0 { O 1 bit } A_2_we0 { O 1 bit } A_2_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A_3 \
    op interface \
    ports { A_3_address0 { O 6 vector } A_3_ce0 { O 1 bit } A_3_we0 { O 1 bit } A_3_d0 { O 32 vector } } \
} "
} else {
...
set InstName stream_matmul_flow_control_loop_pipe_sequential_init_U
set CompName stream_matmul_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix stream_matmul_ \
}"
} else {
