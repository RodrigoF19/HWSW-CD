set moduleName stream_matmul_Pipeline_write_c_i_write_c_j
set isTopModule 0
...
set cdfgNum 8
set C_modelName {stream_matmul_Pipeline_write_c_i_write_c_j}
...
dict set ap_memory_interface_dict C_1 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict C_2 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict C_3 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ C int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ C_1 int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ C_2 int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ C_3 int 32 regular {array 64 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	C { ap_memory {  { C_address0 mem_address 1 6 }  { C_ce0 mem_ce 1 1 }  { C_q0 mem_dout 0 32 } } }
	C_1 { ap_memory {  { C_1_address0 mem_address 1 6 }  { C_1_ce0 mem_ce 1 1 }  { C_1_q0 mem_dout 0 32 } } }
