set moduleName stream_matmul_Pipeline_VITIS_LOOP_74_6_VITIS_LOOP_75_7
set isTopModule 0
...
set cdfgNum 8
set C_modelName {stream_matmul_Pipeline_VITIS_LOOP_74_6_VITIS_LOOP_75_7}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict B { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict B_1 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict B_2 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict B_3 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ B float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ B_1 float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ B_2 float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ B_3 float 32 regular {array 64 { 0 3 } 0 1 }  }
...
set Spec2ImplPortList { 
	B { ap_memory {  { B_address0 mem_address 1 6 }  { B_ce0 mem_ce 1 1 }  { B_we0 mem_we 1 1 }  { B_d0 mem_din 1 32 } } }
	B_1 { ap_memory {  { B_1_address0 mem_address 1 6 }  { B_1_ce0 mem_ce 1 1 }  { B_1_we0 mem_we 1 1 }  { B_1_d0 mem_din 1 32 } } }
	B_2 { ap_memory {  { B_2_address0 mem_address 1 6 }  { B_2_ce0 mem_ce 1 1 }  { B_2_we0 mem_we 1 1 }  { B_2_d0 mem_din 1 32 } } }
	B_3 { ap_memory {  { B_3_address0 mem_address 1 6 }  { B_3_ce0 mem_ce 1 1 }  { B_3_we0 mem_we 1 1 }  { B_3_d0 mem_din 1 32 } } }
