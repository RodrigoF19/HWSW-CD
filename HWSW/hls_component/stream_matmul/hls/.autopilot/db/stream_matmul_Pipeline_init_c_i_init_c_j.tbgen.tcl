set moduleName stream_matmul_Pipeline_init_c_i_init_c_j
set isTopModule 0
...
set cdfgNum 8
set C_modelName {stream_matmul_Pipeline_init_c_i_init_c_j}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict C { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict C_1 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict C_2 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict C_3 { MEM_WIDTH 32 MEM_SIZE 256 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ C int 32 regular {array 64 { 0 3 } 0 1 }  }
	{ C_1 int 32 regular {array 64 { 0 3 } 0 1 }  }
	{ C_2 int 32 regular {array 64 { 0 3 } 0 1 }  }
	{ C_3 int 32 regular {array 64 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ C_1_address0 sc_out sc_lv 6 signal 1 } 
...
set Spec2ImplPortList { 
	...
	C_1 { ap_memory {  { C_1_address0 mem_address 1 6 }  { C_1_ce0 mem_ce 1 1 }  { C_1_we0 mem_we 1 1 }  { C_1_d0 mem_din 1 32 } } }
